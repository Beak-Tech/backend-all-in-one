...
- Install the latest [`django`](https://www.djangoproject.com/) and [`django-rest-framework`](https://www.django-rest-framework.org/) according to your OS (operating system). 
- Also use the following command to install an additional library
  ```
...
- <span style="color:red">[**<u>Required Checkpoint</u>**] </span>
  ...
  - Clone the repo & enter the folder
    ...
    ``` bash
    git clone git@github.com:Beak-Tech/backend-all-in-one.git
